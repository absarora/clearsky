...
#
# Raises Clearsky::WeatherApiError on any API or network failure
...
module Clearsky
  module Weather
    class WeatherApiProvider
      ...
      # @return [Clearsky::Forecast]
      # @raise [Clearsky::WeatherApiError] on API error or network failure
      def fetch_forecast(zip:)
        ...
        raise Clearsky::WeatherApiError, "WeatherAPI request failed: #{e.message}"
      end
      ...
      def handle_response(response, zip:)
        ...
        raise Clearsky::WeatherApiError, "WeatherAPI returned an unparseable response"
      rescue KeyError, TypeError => e
        raise Clearsky::WeatherApiError, "WeatherAPI response missing expected fields: #{e.message}"
      end
